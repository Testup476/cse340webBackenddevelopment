...
VALUES (
    ...
    (
        ...
        'Wrangler',
        '2019',
        'The Jeep Wrangler is small and compact with enough power to get you where you want to go. Its great for everyday driving as well as offroading whether that be on rocks or in the mud!',
        '/images/wrangler.jpg',
...
-- ===================== CRUD OPERATIONS ===================
-- =========================================================
-- 1. Update account type to Admin
...
WHERE account_email = 'tony@starkent.com';
-- 3. Update inventory description using REPLACE function
...
-- 4. Inner join inventory with classification (Sport category)
SELECT i.inv_make,
    i.inv_model,
...
-- 5. Update inventory image paths to include /vehicles
UPDATE public.inventory
